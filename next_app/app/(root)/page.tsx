...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-black text-black overflow-hidden font-mono">
      ...
      <div id="header" className="relative rounded-box p-4 bg-opacity-90 bg-gray-900 z-10">
        <div id="Logo">
      ...
      <div id="main-section" className="relative text-center mt-8 z-10">
        <h1 className="text-2xl font-bold">Welcome to BloodLens!</h1>
      ...
      <div id="about-us-section" className="relative mt-12 z-10">

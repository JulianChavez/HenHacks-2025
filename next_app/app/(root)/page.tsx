      ...
      <div id="header" className="relative rounded-box p-4 bg-opacity-90 bg-gray-400 z-10">
        ...
        <div id="subsection">
          <nav className="flex gap-6">
            <a href="#main-section" className="px-5 py-2 rounded-full bg-gray-700 text-white font-bold shadow-md hover:bg-gray-600 transition-transform transform group-hover:scale-110 group-hover:shadow-xl">Home</a>
            <a href="#about-section" className="px-5 py-2 rounded-full bg-gray-700 text-white font-bold shadow-md hover:bg-gray-600">About</a>
            <a href="#about-us-section" className="px-5 py-2 rounded-full bg-gray-700 text-white font-bold shadow-md hover:bg-gray-600">About Us</a>
          </nav>
        </div>
        <div id="login">
